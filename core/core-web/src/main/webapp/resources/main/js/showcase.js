...
$( "#btnPopupPanelOpen" ).on( "click", function() {	
	   var divname= 'popupPanel';
	if(openPopMenuMobil==false){
		 var h = $( window ).height();
		 $( "#popupPanel" ).css( "height", h );
		 
	  $("#"+divname).show("slide", { direction: "left" }, 1);
	  
	  openPopMenuMobil=true;
	}else{
	 $("#"+divname).hide("slide", { direction: "right" }, 1);
	openPopMenuMobil=false;
	}
